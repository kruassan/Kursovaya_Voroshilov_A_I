...
namespace Kursovaya_Voroshilov_A_I
{
    public partial class Admin_Resumes : Form
    {
        ...
        {
            if (W4A.SetZapros("update Резюме set Код_работника =" + Panel_Code_Of_Rabotnick.Text + ",Образование ='" + Panel_Bank.Text + "', Желаемая_з_п=" + Panel_Type.Text + ",График='" + Panel_Razm.Text + "' where Код_резюме =" + Panel_Tranzaction_Code.Text + ";") > 0)
            {
        ...
        {
            W4A.SetZapros("INSERT INTO Резюме (Код_работника,Образование,Желаемая_з_п,График) VALUES (" + Dobavleniye_Name_TB.Text + ",'" + Dobavleniye_Family_TB.Text + "'," + textBox4.Text + ",'" + textBox5.Text + "');");
