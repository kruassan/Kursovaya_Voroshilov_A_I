...
namespace Kursovaya_Voroshilov_A_I
{
    public partial class Admin_Vacancyes : Form
    {
        ...
        {
            if (W4A.SetZapros("update Вакансии set Код_специальности =" + Panel_Code_Of_Rabotnick.Text + ",Код_предприятия =" + Panel_Bank.Text + ", Можно_до_18=" + Panel_Type.Text + ",Заявленная_заработная_плата=" + Panel_Razm.Text + ",Актуально_до=#" + Panel_Date.Text.Replace('.', '-') + "# where Код_записи =" + Panel_Tranzaction_Code.Text + ";") > 0)
            {
        ...
        private void Dobavleniye_Dobavit_Button_Click(object sender, EventArgs e)
        {
            ...
            W4A.SetZapros("INSERT INTO Вакансии (Код_специальности,Код_предприятия,Можно_до_18,Заявленная_заработная_плата,Актуально_до) VALUES (" + Dobavleniye_Name_TB.Text + "," + Dobavleniye_Family_TB.Text + "," + actualn + ",'" + textBox5.Text + "',#" + textBox6.Text.Replace('.', '-') + "#);");
